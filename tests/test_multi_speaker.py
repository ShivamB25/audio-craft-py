...
async def test_multi_speaker():
    ...
    multi_speaker_config = MultiSpeakerConfig(
        speakers=[
            SpeakerConfig(
                speaker_name="Alice", voice_name=VoiceName.SULAFAT  # Warm voice
            ),
            SpeakerConfig(speaker_name="Bob", voice_name=VoiceName.KORE),  # Firm voice
        ]
    )
...
async def test_multi_speaker_with_emotions():
    ...
    multi_speaker_config = MultiSpeakerConfig(
        speakers=[
            SpeakerConfig(
                speaker_name="Emma", voice_name=VoiceName.PUCK  # Upbeat voice
            ),
            SpeakerConfig(
                speaker_name="David", voice_name=VoiceName.GACRUX  # Mature voice
            ),
        ]
    )
    ...
    voice_combinations = [
        {
            ...
            "speakers": [
                SpeakerConfig(
                    speaker_name="Manager", voice_name=VoiceName.KORE
                ),  # Firm
                SpeakerConfig(
                    speaker_name="Employee", voice_name=VoiceName.ACHIRD
                ),  # Friendly
            ],
...
Employee: Our team's dedication and the new process improvements made a significant difference.""",
        },
        {
            ...
            "speakers": [
                ...
                SpeakerConfig(
                    speaker_name="Jordan", voice_name=VoiceName.CALLIRRHOE
                ),  # Easy-going
            ],
