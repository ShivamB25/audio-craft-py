...
class TestRunner:
    ...
    def print_summary(self):
        ...
        if failed == 0:
            ...
            print(f"   🎧 You can listen to the generated audio files in the output/ directory")
            ...
            print(f"   💡 Common issues: API key problems, network connectivity, missing dependencies")
